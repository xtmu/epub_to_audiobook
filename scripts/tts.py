...
# IO
INPUT_FILE = "/home/lwf/repo/epub_to_audiobook/scripts/data/input.txt"
f = open(INPUT_FILE, 'r')
TEXT = f.read()
OUTPUT_FILE = os.path.splitext(INPUT_FILE)[0] + ".mp3"
WEBVTT_FILE = os.path.splitext(INPUT_FILE)[0] + ".vtt"

# TEXT = ""
# OUTPUT_FILE = "/home/lwf/Desktop/output.mp3"
# WEBVTT_FILE = "/home/lwf/Desktop/output.vtt"
...
if __name__ == "__main__":
    print("\033[31m请确保代理已关闭\033[0m")
    print(f"输入文件：{INPUT_FILE}")
    print(f"输出文件：{OUTPUT_FILE}")
    print(f"WEBVTT文件：{WEBVTT_FILE}")
    print(f"完成后打开：{'on' if auto_open else 'off'}")
